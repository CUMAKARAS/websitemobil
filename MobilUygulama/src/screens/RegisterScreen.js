...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 24, width: '100%', maxWidth: 500, elevation: 4, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, marginTop: 30, marginBottom: 30 },
  ...
  infoBox: { backgroundColor: '#eaf4ff', borderRadius: 8, padding: 12, marginBottom: 18 },
  infoText: { color: '#168aff', fontSize: 16, textAlign: 'center' },
  row: { flexDirection: 'row', gap: 12, marginBottom: 10 },
  inputCol: { flex: 1 },
  label: { fontWeight: 'bold', color: '#222', marginBottom: 4, marginTop: 8 },
  required: { color: 'red' },
  input: { borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 10, marginBottom: 10, backgroundColor: '#f9f9f9', fontSize: 16 },
  checkboxRow: { flexDirection: 'row', alignItems: 'center', marginVertical: 10 },
  checkboxText: { marginLeft: 8, color: '#222', flex: 1, flexWrap: 'wrap' },
  ...
  loginText: { textAlign: 'center', color: '#444', marginTop: 10 },
